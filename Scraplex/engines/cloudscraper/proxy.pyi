"""IDE stubs: mirror cloudscraper public API (install Scraplex[cloudscraper] in active venv)."""
...
from Scraplex.engines.cloudscraper._docs import CREATE_SCRAPER_KWARGS, GET_TOKENS_KWARGS
...
# ---------------------------------------------------------------------------
# Scraplex proxy — same surface as ``import cloudscraper``
# ---------------------------------------------------------------------------
