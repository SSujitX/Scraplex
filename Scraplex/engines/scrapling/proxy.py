...
from Scraplex.engines.scrapling._docs import PROXY_CLASS
...
class ScraplingProxy:
    ...
    def __init__(self) -> None:
        """Bind scrapling API; requires Scraplex[scrapling]."""
        from Scraplex.engines.scrapling.engine import _ensure_dependencies
